...
loss.mask_vector = tf.constant([num_classes]*770,tf.int64)
...
def init_model():
    ...
    #trimming by cnn
    #(775,256)
    xx = Reshape( (775,256,1) )(xx) 
    xx = Conv2D(20,kernel_size = (6,256),use_bias = True,activation = 'relu',padding = 'valid')(xx)
    xx = Reshape( (770,20) )(xx) 
...
if __name__ == '__main__':
    ...
    cks = ModelCheckpoint('../best_directly.{epoch:02d}-{val_loss:.2f}.cks',save_best_only=True,period = 1)
