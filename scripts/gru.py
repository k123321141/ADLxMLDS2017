...
model.add(GRU(features_count,input_dim = features_count, activation='relu',return_sequences=True))
model.add(GRU(features_count, activation='relu',return_sequences=True,implementation=1))
#
