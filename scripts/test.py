...
#dic init setting,reshape
    ...
    #
    rnn_out = rnn.output(rnn_input,hidden_dim = 256,activation = 'tanh',rnn_lay = LSTM,bidirect = True,depth = 2,dropout = 0.10)
    rnn_out = Dropout(0.25)(rnn_out)
    ...
    cks = ModelCheckpoint('../checkpoints/test.{epoch:02d}-{val_loss:.2f}.model',save_best_only=True,period = 2)
