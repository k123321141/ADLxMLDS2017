...
def main():    
    ...
    #
    generator.load_weights('./models/params_generator_iters_049.hdf5')
    discriminator.load_weights('./models/params_discriminator_iters_049.hdf5')

    for iters in range(50,10000000000):
